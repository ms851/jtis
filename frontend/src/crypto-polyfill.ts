/**
 * Polyfill for crypto.subtle in non-secure (HTTP) contexts.
 * 
 * oidc-client-ts requires crypto.subtle.digest('SHA-256', ...) for PKCE.
 * This API is only available in secure contexts (HTTPS).
 * This polyfill provides a pure-JS SHA-256 implementation as fallback.
 * 
 * IMPORTANT: Import this BEFORE any oidc-client-ts imports.
 */

// Minimal SHA-256 implementation (based on FIPS 180-4)
...
// Apply polyfill if crypto.subtle is not available
...
if (typeof globalThis.crypto?.subtle === 'undefined') {
  console.warn('[JTIS] crypto.subtle not available (HTTP context). Using polyfill.');
